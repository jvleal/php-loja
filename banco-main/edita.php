...
<html lang="pt-br">
    ...
    <body>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-ligth bg-ligth">
                <div class="container-fluid">
                    <h3><b>Acesso a cadastros loja</b></h3>
                        ...
                        <div class="card mb-2 rounded-2 shadow-sm">
                            ...
                            <form action="editar.php?id=<?php echo $id; ?>" method="POST">
                                <div class="form-group col-7">
                                    ...
                                    <input type="date" class="form-control" name="data_nacimento" value="<?php echo $data_n; ?>" required/>
                                    <br/>
        ...
        <footer>
            <hr/>
            <center><b>Acesso a cadastros loja - Desenvolvida pela turma TDS06 - 2021</b></center>
        </footer>
    </body>
</html>